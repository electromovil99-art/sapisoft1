...
const WhatsAppModule: React.FC<WhatsAppModuleProps> = ({ products, clients, chats, setChats, initialContact }) => {
    ...
    }, [isSending, sendingProgress, clients, chats, bulkMessage, msgInterval, campaignImage, antiBanMode]);
    ...
    return (
        <div className="flex flex-col h-full bg-slate-200 overflow-hidden rounded-xl border border-slate-300 shadow-2xl relative">
            ...
            <div className="flex flex-1 overflow-hidden relative">
                ...
                {isExtensionOpen ? (
                    <div className="absolute right-4 top-4 bottom-4 w-80 bg-white shadow-2xl rounded-lg border border-gray-200 z-50 flex flex-col animate-in slide-in-from-right-10 duration-300">
